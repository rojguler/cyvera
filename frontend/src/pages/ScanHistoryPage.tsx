    ...
    <div className="p-4 sm:p-8 space-y-6 max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight flex items-center gap-2.5">
            ...
            <span>Scan History & Log Archive</span>
          </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="cyber-input text-xs py-1.5 font-sans"
          >
      ...
      {loading ? (
        <div className="py-20 text-center text-xs text-slate-400 flex flex-col items-center gap-3">
          ...
          <span className="font-mono">Retrieving Historical Records...</span>
        </div>
      ) : scans.length === 0 ? (
                ...
                {scans.map((scan) => (
                  <tr key={scan.id} className="hover:bg-slate-850/50 transition-colors">
                    ...
                    <td className="py-4 px-4 font-bold text-white">
                      ...
                      <div className="text-[11px] font-mono text-slate-400 font-normal truncate max-w-xs">{scan.target_url}</div>
                    </td>
                    ...
                    <td className="py-4 px-4 font-black text-sm font-mono">
                    ...
                    <td className="py-4 px-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-200 text-xs font-semibold border border-slate-700/60 hover:border-cyan-500/40 transition-colors"
                      >
