...
import { FileText, Download, ShieldCheck, Calendar, ExternalLink, Activity, Sparkles } from 'lucide-react';
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        <div className="py-16 text-center text-xs text-slate-400 flex flex-col items-center gap-3">
          ...
          <span>Generating Report Catalog...</span>
        </div>
      ) : scans.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {scans.map((scan) => (
            <div
              ...
              className="cyber-card p-5 cursor-pointer flex flex-col justify-between hover:border-cyan-500/60 transition-all group"
            >
              <div>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="text-base font-bold text-white mt-2 group-hover:text-cyan-300 transition-colors truncate max-w-[220px]">
                      {scan.target_name}
                    </h3>
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <span className={`text-base font-black ${
                      (scan.security_score || 0) >= 80 ? 'text-emerald-400' : (scan.security_score || 0) >= 60 ? 'text-amber-400' : 'text-red-400'
                    }`}>
                ...
                <div className="mt-4 p-3 rounded bg-slate-900/60 border border-slate-800 text-[11px] text-slate-300 space-y-1">
              ...
              <div className="mt-5 pt-4 border-t border-slate-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-cyan-950/80 hover:bg-cyan-900 border border-cyan-500/40 text-cyan-300 text-xs font-bold uppercase tracking-wider transition-all disabled:opacity-50"
                >
